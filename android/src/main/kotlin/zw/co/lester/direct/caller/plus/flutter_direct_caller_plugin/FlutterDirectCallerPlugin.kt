package zw.co.lester.direct.caller.plus.flutter_direct_caller_plugin
...
/** FlutterDirectCallerPlugin  */
class FlutterDirectCallerPlugin : FlutterPlugin, ActivityAware {
  private var handler: FlutterPhoneDirectCallerHandler? = null
  override fun onAttachedToEngine(binding: FlutterPluginBinding) {
    handler = FlutterPhoneDirectCallerHandler()
    val channel = MethodChannel(
      binding.binaryMessenger, "flutter_direct_caller_plugin"
    )
